...
const FirebaseAuth = () => {
  ...
  const handleSignup = async (data: SignupFormValues) => {
    ...
    try {
      ...
      // Update the user's display name to include role
      await updateProfile(userCredential.user, {
        displayName: `${data.role}-user`
      });
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        if (error.message.includes("user-not-found")) {
          ...
          errorMessage = "Access temporarily disabled due to many failed login attempts. Try again later or reset your password.";
        }
      }
